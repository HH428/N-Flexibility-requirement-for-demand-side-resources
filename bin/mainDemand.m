...
% Ramping 5min
rampDemand5 = abs(powerDemand5(2:end) - powerDemand5(1:end-1)); % per min
...
rampDemand15 = abs(powerDemand15(2:end) - powerDemand15(1:end-1)); % per min
...
rampDemand60 = abs(powerDemand60(2:end) - powerDemand60(1:end-1)); % per min

powerMax = max(powerDemand5);
...
Demand5Ramping = centersDemand5(tempIdx)/powerMax
...
Demand15Ramping = centersDemand15(tempIdx)/powerMax
...
Demand60Ramping = centersDemand60(tempIdx)/powerMax
